...
<body class="bg-gray-100 font-sans dark:bg-gray-900">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mb-6 dark:text-white">Activity Log</h1>

        <div class="flex flex-wrap gap-4 mb-6 items-center">
             <div>
                 <label for="activityDateRange" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Date Range:</label>
                 <select id="activityDateRange" class="block appearance-none w-full bg-white border border-gray-300 hover:border-gray-400 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline dark:bg-gray-700 dark:border-gray-600 dark:text-white text-sm">
             ...
             <div>
                 ...
                 <select id="activityTypeFilter" class="block appearance-none w-full bg-white border border-gray-300 hover:border-gray-400 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline dark:bg-gray-700 dark:border-gray-600 dark:text-white text-sm">
             ...
             <div>
                  <label for="activityAdminFilter" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Admin User:</label>
                  <select id="activityAdminFilter" class="block appearance-none w-full bg-white border border-gray-300 hover:border-gray-400 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline dark:bg-gray-700 dark:border-gray-600 dark:text-white text-sm">
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700" id="activityLogTableBody">
                        <tr>
                            <td colspan="4" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center dark:text-gray-400 table-message">Loading activity log...</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="px-6 py-4 flex items-center justify-between border-t border-gray-200 dark:border-gray-700">
                <div class="flex-1 flex justify-between sm:hidden">
                    <button id="activityPrevMobile" class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-600"> Previous </button>
                    <button id="activityNextMobile" class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-600"> Next </button>
                </div>
                <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                    ...
                    <div>
                        <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                            <button id="activityPrev" class="relative inline-flex items-center px-2 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-600">
                                <span class="sr-only">Previous</span>
                                <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                    <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd" />
                                </svg>
                            </button>
                            <span id="activityPageNumbers" class="relative inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-sm font-medium text-gray-700 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                                ...
                            </span>
                            <button id="activityNext" class="relative inline-flex items-center px-2 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-600">
    ...
    <script>
       ...
       function formatDateTime(dateTimeStr) {
        ...
        async function fetchActivityLog(page = 1, itemsPerPage = 10, dateRange = 'all_time', activityType = 'all', adminUser = 'all') {
            ...
            // Show loading state
            tableBody.innerHTML = `<tr><td colspan="4" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center dark:text-gray-400 table-message">Loading activity log...</td></tr>`;
            ...
            try {
                ...
                updateActivityLogTable([]); // Update table with empty data
                updateActivityLogPagination(); // Update pagination controls
                 tableBody.innerHTML = `<tr><td colspan="4" class="px-6 py-4 whitespace-nowrap text-sm text-red-600 text-center dark:text-red-500 table-message">Error loading activity log.</td></tr>`;
            }
        }
        ...
        function updateActivityLogTable(activity) { // Takes the array of activity entries
            ...
            if (activity && activity.length > 0) {
                activity.forEach(entry => {
                 ...
                 tableBody.innerHTML = `
                     <tr>
                         <td colspan="4" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center dark:text-gray-400 table-message">No activity found.</td>
                     </tr>
                 `;
            }
        }
        ...
        function updateActivityLogPagination() {
            ...
            if (totalRecords === 0) {
                ...
                if (showingToEl) showingToTo.textContent = '0'; // Corrected ID
            } else {
            ...
            // Optional: Implement clickable page numbers if needed
        }
        ...
        function handleActivityPaginationClick(event) {
            ...
            // const search = document.getElementById('activitySearch').value; // if implemented


            if (targetId === 'activityPrev' || targetId === 'activityPrevMobile') {
                if (activityCurrentPage > 1) {
                    activityCurrentPage--;
                    fetchActivityLog(activityCurrentPage, activityItemsPerPage, dateRange, activityType, adminUser); // Pass current filters
                }
            } else if (targetId === 'activityNext' || targetId === 'activityNextMobile') {
                const totalPages = Math.ceil(activityTotalRecords / activityItemsPerPage);
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // const activitySearchInput = document.getElementById('activitySearch'); // if implemented
            ...
            if (activityAdminFilterSelect) activityAdminFilterSelect.addEventListener('change', function() {
             ...
             // Add event listener for search input (if implemented)
             /*
             if (activitySearchInput) activitySearchInput.addEventListener('input', function() {
                  activityCurrentPage = 1; // Reset to first page on search
                  fetchActivityLog(activityCurrentPage, activityItemsPerPage, activityDateRangeSelect.value, activityTypeFilterSelect.value, activityAdminFilterSelect.value); // Pass all current filters
             });
             */
            ...
            // Optional: Add event listener for items per page select if you add one
            // const activityItemsPerPageSelect = document.getElementById('activityItemsPerPageSelect');
            // if (activityItemsPerPageSelect) activityItemsPerPageSelect.addEventListener('change', function() {
            //     activityItemsPerPage = parseInt(this.value, 10);
            //     activityCurrentPage = 1; // Reset to first page
            //     fetchActivityLog(activityCurrentPage, activityItemsPerPage, activityDateRangeSelect.value, activityTypeFilterSelect.value, activityAdminFilterSelect.value);
            // });
